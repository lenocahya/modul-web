...
1. Silahkan download file installer dari [Visual Studio Code](https://code.visualstudio.com/download). Klik download pada halaman web Visual Studio Code sesuai dengan sistem operasi yang digunakan.

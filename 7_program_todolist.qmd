...
# 1 Program To Do List {.unnumbered}
...
<br>
Dari tabel diatas dapat dibuat pada [localhost/phpmyadmin](http://localhost/phpmyadmin/) dengan membuat database baru lalu membuat tabel baru dengan nama tabel "kegiatan". Buat field dan sesuaikan pada tabel di atas mulai dari nama field, type dan sizenya. Field "id" berfungsi sebagai primary key. Pada field isi, tgl_awal, dan tgl_akhir tidak memerlukan size karena bertipe text dan date. Pada field status bertipe int dengan size hanya 1 karena nantinya akan menyimpan nilai 0 dan 1 yang merepresentasikan belum dan sudah.
<br>

...
1. Unduh file installer dari website [XAMPP](https://www.apachefriends.org/download.html)
2. Lakukan instalasi XAMPP sesuai panduan (wizard) yang ditampilkan dan pilih Yes untuk melanjutkan instalasi.
...
5. Lakukan instalasi Bitnami untuk memudahkan dalam memasang WordPress, Drupal atau Joomla secara otomatis.
<br>

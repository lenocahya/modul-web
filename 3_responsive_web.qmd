...
Bootstrap merupakan HTML, CSS dan Javascript framework paling popular untuk mengambangkan responsive web design yang mengutamakan tampilan mobile (mobile first) Bootstrap dapat diunduh secara gratis pada laman [https://getbootstrap.com/](https://getbootstrap.com/). Sampai saat modul ini dibuat versi terakhir adalah Bootstrap v5.3.
...
![Tabel Penjelasan Grid](assets/responsive/gridtable.png){width="70%" style="text-align:center;"}

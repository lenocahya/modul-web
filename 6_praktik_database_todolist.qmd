...
format: html
categories: [database, praktik]
---

# Praktik Database {.unnumbered}
...
![Tabel To Do List](assets/database/tabel){width="50%" style="text-align:center;"}
...
Berikut merupakan video penjelasan mengenai phpmyadmin

{{< video https://www.youtube.com/embed/fxe6qev-bno?controls=0&amp;start=2453 >}}

Untuk membuat database menggunakan phpMyAdmin perlu mengaktifkan terlebih dahulu apache dan mysql pada xampp agar terhubung pada phpMyAdmin. Lalu memulai aplikasi phpMyAdmin melalui [http://localhost/phpmyadmin/](http://localhost/phpmyadmin/)
...
![Create Database melalui Platform](assets/database/create%20database.png){width="80%" style="text-align:center;"}
...
![Create Table](assets/database/create%20tabel.png){width=80% style="text-align:center;"}
